...
person1.addEventListener('click', function(){ changeInfo(0); });
person2.addEventListener('click', function(){ changeInfo(1) });
person3.addEventListener('click', function(){ changeInfo(2) });
person4.addEventListener('click', function(){ changeInfo(3) });
person5.addEventListener('click', function(){ changeInfo(4) });
person6.addEventListener('click', function(){ changeInfo(5) });
person7.addEventListener('click', function(){ changeInfo(6) });
person8.addEventListener('click', function(){ changeInfo(7) });
person9.addEventListener('click', function(){ changeInfo(8) });
person10.addEventListener('click', function(){ changeInfo(9) });
person11.addEventListener('click', function(){ changeInfo(10) });
person12.addEventListener('click', function(){ changeInfo(11) });
person13.addEventListener('click', function(){ changeInfo(12) });
person14.addEventListener('click', function(){ changeInfo(13) });
person15.addEventListener('click', function(){ changeInfo(14) });