 class IOTMailbox {
  ...
  signalStateChange = () => {
    ...
    createNewLog(`Mailbox state changed - lightLevel: ${lightLevel}`, lightLevel);
...
function createNewLog(text, light){
  ...
  if(text === `Starting monitoring of mailbox...`)
    newLog.style.color = '#0f0';
  if(text === `Mailbox monitoring stopped...`)
