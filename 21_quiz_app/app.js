const questions = [{
  ...
  answers: ['JavaScript Only Notation', 'Joe Smith On Narcotics', 'JavaScript Object Notation', 'JavaScript Operation Notation'],
  correctAnswer: 'JavaScript Object Notation',
  questionNumber: 1
},{
  question: 'What does CSS stand for?',
  answers: ['Cascading Style Sheet', 'Combined Source Sheet', 'Cooperative Style Section', 'Cool Style Sheet'],
  ...
  answers: ['Hypertext Markdown Language', 'Hype Text Manager Lemon', 'Hypertext Markup Language', 'Hypertext Management Language'],
  ...
  answers: ['Structured Query Language', 'Super Query Language', 'Slow Query Language', 'Semantic Query Language'],
