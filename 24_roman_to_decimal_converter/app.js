...
function convertToDec(romanIn){
  ...
  for(let i = 0; i < romanIn.length; i = i + t){
    if(romanIn[i] == '('){ strArr.push(`(${romanIn[i + 1]})`); t = 3;}
    else { 
  ...
  let frq = [{ value: 1, count: 1 }, { value: 5, count: 1 }, { value: 10, count: 1 }, { value: 50, count: 1 }, { value: 100, count: 1 }, { value: 500, count: 1 }, { value: 1000, count: 1 }, { value: 5000, count: 1 }, { value: 10000, count: 1 }, { value: 50000, count: 1 }, { value: 100000, count: 1 }, { value: 500000, count: 1 }, { value: 1000000, count: 1 }];

  // UPDATE FREQUENCY OF NUMBERS
  for(let i = 0; i < strArr2.length; i++){
    if(strArr2[i - 1] == strArr2[i]){
      frq.forEach(element => {
        if(strArr2[i] == element.value) 
          element.count++;
      });
    } else {
      frq.forEach(element => {
  ...
  if(checkFrq(frq)){
    ...
    for(let i = 0; i < strArr2.length; i = i + k){
      if(strArr2[i] < strArr2[i + 1]){
        if((strArr2[i + 1] == strArr2[i] * 10) || (strArr2[i + 1] == strArr2[i] * 5) ){
...
function checkOrder(arrSub){
  let ok = true;
  for(let i = 0; i < arrSub.length; i++){
    if(arrSub[i] == 900 || arrSub[i] == 400 || arrSub[i] == 90 || arrSub[i] == 40 || arrSub[i] == 9 || arrSub[i] == 4){
      ...
      if(arrSub[i] == 1000000)
        if(arrSub[i + 1] > 1000000) ok = false;
      if(arrSub[i] == 500000)
        if(arrSub[i + 1] > 100000) ok = false;
      if(arrSub[i] == 100000)
        if(arrSub[i + 1] > 100000) ok = false;
      if(arrSub[i] == 50000)
        if(arrSub[i + 1] > 10000) ok = false;
      if(arrSub[i] == 10000)
        if(arrSub[i + 1] > 10000) ok = false;
      if(arrSub[i] == 5000)
        if(arrSub[i + 1] > 1000) ok = false;
      if(arrSub[i] == 1000)
        if(arrSub[i + 1] > 1000) ok = false;
      if(arrSub[i] == 500)
        if(arrSub[i + 1] > 100) ok = false;
      if(arrSub[i] == 100)
        if(arrSub[i + 1] > 100) ok = false;
      if(arrSub[i] == 50)
        if(arrSub[i + 1] > 10) ok = false;
      if(arrSub[i] == 10)
        if(arrSub[i + 1] > 10) ok = false;
      if(arrSub[i] == 5)
        if(arrSub[i + 1] > 1) ok = false;
      if(arrSub[i] == 1)
        if(arrSub[i + 1] > 1) ok = false;
    }
  }
...
const mainNumbers = [{ romanValue: 'I', decimalValue: 1 }, 
...
back2.addEventListener('click', () => decimalInputField.value = decimalInputField.value.slice(0, -1));
...
convert2.addEventListener('click', () => {
  ...
  if(num == 'only numbers from [1,3999999]') romanOutputField.style.color = '#f00';
});